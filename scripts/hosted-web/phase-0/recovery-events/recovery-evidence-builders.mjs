...
export function buildReport({ catalog, scheduler, effectMatrix, goldens }) {
  ...
  return (
    ...
    `- The external ownership gate compares ${catalog.coverage.crossLaneOwnership.comparedW1ApiMembers} required W1/W5 API members against the W1 API parity ledger and ${catalog.coverage.crossLaneOwnership.comparedW1ActionBindings} approval mutations against the W1 renderer action inventory. It fails generation on a missing row or primary command-owner drift. Coordinator effects remain owned by the primary command feature; published secondary effects retain their distinct effect owner.\n` +
