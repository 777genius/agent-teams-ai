...
// This root-owned script may only change after its fixed-directory chown scope is reviewed.
export const CADDY_VOLUME_OWNER_SCRIPT_SHA256 =
  '848df33840245117b6e91085446db6ddeebecabfe8737d38abbc2b2624fa314b';

// prettier-ignore
export const PROFILE_SERVICES = Object.freeze({ personal: Object.freeze(['agent-teams-personal', 'agent-teams-lifecycle-trust-init', 'caddy-personal', 'caddy-personal-volume-owner-init']), keycloak: Object.freeze(['agent-teams-keycloak', 'agent-teams-keycloak-secret-init', 'agent-teams-lifecycle-trust-init', 'caddy', 'caddy-volume-owner-init', 'keycloak', 'keycloak-postgres', 'keycloak-volume-init']) });
// prettier-ignore
...
// prettier-ignore
export const EXPECTED_TMPFS = Object.freeze({ 'agent-teams-personal': Object.freeze(['/home/node:mode=0700,uid=1000,gid=1000', '/run/agent-teams:mode=0700,uid=1000,gid=1000', '/tmp:mode=1777']), 'agent-teams-keycloak': Object.freeze(['/home/node:mode=0700,uid=1000,gid=1000', '/run/agent-teams:mode=0700,uid=1000,gid=1000', '/tmp:mode=1777']), caddy: Object.freeze(['/tmp:mode=1777']), 'caddy-personal': Object.freeze(['/tmp:mode=1777']), 'caddy-volume-owner-init': Object.freeze([]), 'caddy-personal-volume-owner-init': Object.freeze([]), keycloak: Object.freeze(['/opt/keycloak/data/import:mode=0700,uid=1000,gid=0', '/opt/keycloak/data/tmp:mode=0700,uid=1000,gid=0', '/run/keycloak:mode=0700,uid=1000,gid=0', '/tmp:mode=1777']), 'keycloak-postgres': Object.freeze(['/tmp:mode=1777', '/var/run/postgresql:mode=0775,uid=70,gid=70']), 'keycloak-volume-init': Object.freeze([]), 'agent-teams-keycloak-secret-init': Object.freeze([]), 'agent-teams-lifecycle-trust-init': Object.freeze([]) });
// prettier-ignore
