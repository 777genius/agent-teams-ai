...
import type { SelectedPublicArtifactName } from './supervisor/public-artifacts';
...
export async function admitIntegration(
  ...
  try {
    ...
    await closeAnchors([
      ...
      actionsZip,
      platformArchive,
      ...(selectedSupervisorArtifacts ? [] : Object.values(publicArtifacts)),
      compositionEntry,
      playwrightEntry,
      playwrightConfig,
      playwrightSpec,
    ...
    return Object.freeze({
      descriptor,
      ...(selectedSupervisorArtifacts ? { selectedSupervisorArtifacts } : {}),
