...
import { enqueueCodexGoalControlSignal, inspectCodexGoalControlDecision, listCodexGoalControlSignals, pauseCodexGoalWorker, reconcileCodexGoalControlInbox, sendCodexGoalGuidance, supersedeCodexGoalControlSignal, } from "./application/codex-goal-worker-control-use-cases.js";
export function registerCodexGoalWorkerControlTools(server, options = {}) {
    ...
    }, async (args) => withMcpErrors(async () => mcpJson(await pauseCodexGoalWorker(args))));
    ...
    }, async (args) => withMcpErrors(async () => mcpJson(await sendCodexGoalGuidance(args, options))));
    ...
    }, async (args) => withMcpErrors(async () => mcpJson(await enqueueCodexGoalControlSignal(args))));
    ...
    }, async (args) => withMcpErrors(async () => mcpJson(await listCodexGoalControlSignals(args))));
    server.registerTool("codex_goal_control_decision", {
        ...
        inputSchema: jobIdInputSchema(),
    }, async (args) => withMcpErrors(async () => mcpJson(await inspectCodexGoalControlDecision(args))));
    ...
    }, async (args) => withMcpErrors(async () => mcpJson(await reconcileCodexGoalControlInbox(args))));
    ...
    }, async (args) => withMcpErrors(async () => mcpJson(await supersedeCodexGoalControlSignal(args))));
}
