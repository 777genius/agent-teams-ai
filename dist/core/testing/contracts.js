...
export function providerSessionDriverContract(name, factory) {
    describe(`${name} provider session driver contract`, () => {
        ...
        it("classifies failures without leaking token field names", () => {
            const fixture = factory();
            const failure = fixture.driver.classifySessionFailure(fixture.reconnectError);
        ...
        it("declares capabilities before runtime starts", () => {
            ...
            expect(fixture.driver.capabilities.sessionRequirement.kind).toBe("required");
            if (fixture.driver.capabilities.sessionRequirement.kind === "required") {
                expect(fixture.driver.capabilities.sessionRequirement.artifactKinds.length).toBeGreaterThan(0);
            }
        });
    });
}
export function agentDriverContract(name, factory) {
...
export function sessionStoreContract(name, factory) {
