export const EXTERNAL_WRITER_RECONCILIATION_MIGRATION_STATEMENTS = Object.freeze([
  `CREATE TABLE IF NOT EXISTS external_writer_reconciliation_receipts (
  ...
  `CREATE TRIGGER IF NOT EXISTS external_writer_reconciliation_no_update
  ...
  `CREATE TRIGGER IF NOT EXISTS external_writer_reconciliation_no_delete
