...
export default interface Resources {
  ...
  "team": {
    ...
    "messageComposer": {
      ...
      "status": {
        "memoryOnly": "Saved only until the app closes",
        "previousDeliveryUnknown": "Previous delivery is unknown; sending again may create a duplicate",
    ...
    "messages": {
      ...
      "chats": {
        ...
        "clearSearch": "Clear search",
        "draft": "Draft",
        "draftAttachments_one": "{{count}} attachment",
        "draftAttachments_other": "{{count}} attachments",
        "draftReferences_one": "{{count}} reference",
        "draftReferences_other": "{{count}} references",
      ...
      "outbox": {
        ...
        "deleteDescription": "This removes the local copy and cannot be undone.",
        "errors": {
          "active": "This message is still being sent.",
          "changed": "The saved copy changed. Nothing was overwritten.",
          "deleteBlocked": "The local copy could not be removed safely.",
          "draftOccupied": "This chat already has a draft. Nothing was overwritten."
        },
        "recoveredFor": "Recovered from {{target}}",
        "removeUnknownDescription": "This removes only the local copy. Delivery may already have happened, so retrying can create a duplicate.",
        "status": {
          "delivery-unknown": "Delivery unknown",
          "memoryOnly": "saved until the app closes",
          "not-sent": "Not sent",
          "recovered-draft": "Recovered draft",
          "sending": "Sending...",
          "syncing": "Sent - syncing..."
        },
        "storageWarning": "Some local delivery details could not be read. Last known messages remain visible."
      },
