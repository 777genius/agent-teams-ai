...
export interface LegacyMemberSettingsRepositoryDependencies {
  membersMetaStore: {
    getMeta(teamName: string): Promise<LegacyMemberSettingsMetadataFile | null>;
    writeMembers(
      teamName: string,
      members: TeamMember[],
...
export interface LegacyMemberSettingsMetadataFile {
...
interface LoadedTarget {
  ...
  meta: LegacyMemberSettingsMetadataFile | null;
...
export function createLegacyMemberSettingsRepository(
  dependencies: LegacyMemberSettingsRepositoryDependencies
): MemberSettingsRepositoryPort {
  return new LegacyMemberSettingsRepositoryAdapter(dependencies);
}
