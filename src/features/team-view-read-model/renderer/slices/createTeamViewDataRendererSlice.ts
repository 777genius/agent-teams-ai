import { defaultTeamViewDataCoordinator } from '../utils/teamViewDataCoordinator';
...
export type { TeamViewDataRendererSliceDependencies } from '../ports/TeamViewDataRendererPorts';
