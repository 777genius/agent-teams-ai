...
export type HostedCoordinationEventBootstrapRequest = Readonly<
  | {
 ...
 */
export type HostedCoordinationEventBootstrapSnapshot = Readonly<
  | {
      readonly schemaVersion: typeof HOSTED_COORDINATION_EVENT_BOOTSTRAP_SCHEMA_VERSION;
  ...
  | {
      readonly schemaVersion: typeof HOSTED_COORDINATION_EVENT_BOOTSTRAP_SCHEMA_VERSION;
      readonly kind: 'workspace_event_bootstrap';
      readonly workspaceId: WorkspaceId;
    }
>;
