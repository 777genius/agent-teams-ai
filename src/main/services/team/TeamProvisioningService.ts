...
export class TeamProvisioningService {
  ...
  private buildProviderModelLaunchIdentity(params: {
    ...
    return {
      providerId,
      providerBackendId: migrateProviderBackendId(providerId, params.request.providerBackendId) ?? null,
  ...
  private async resolveAndValidateLaunchIdentity(params: {
    ...
    cwd: string;
    env: NodeJS.ProcessEnv;
    request: Pick<TeamCreateRequest, 'providerId' | 'providerBackendId' | 'model' | 'effort' | 'limitContext'>;
    effectiveMembers: TeamCreateRequest['members'];
