...
export type CodexGoalJobUpdateInput =
  CodexGoalJobIdInput & Partial<CodexGoalJobCreateInput>;
...
export function registryRootFromInput(args: CodexGoalJobRegistryInput): string {
