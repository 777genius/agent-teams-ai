...
import {
  ...
  type OpenAiBridgeChatBackendInput,
  type OpenAiBridgeChatBackendResult,
} from "./types.js";
...
async function seedIsolatedBridgeAccount(input: {
  readonly stateDir: string;
  readonly account: CodexOpenAiBridgeAccount;
}): Promise<Pick<AccountState, "home" | "codexHome">> {
