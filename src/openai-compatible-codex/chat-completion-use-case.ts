...
import { renderOpenAiBridgeChat } from "./message-renderer.js";
import {
...
function parseMessages(value: unknown): OpenAiBridgeChatCompletionRequest["messages"] {
...
function parseContent(
  ...
  return value.map((part) => {
    ...
    if (record.type !== OpenAiBridgeContentPartType.Text || typeof record.text !== "string") {
      throw new OpenAiBridgeRequestError(
