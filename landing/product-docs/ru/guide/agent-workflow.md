...
Во вкладке **Messages** доступны личные беседы с участниками команды. Если работа остановилась, используйте действие продолжения на странице команды, а затем проверьте реальный прогресс по задаче и runtime-логам. Подробнее - в разделе [Запуск и мониторинг](/ru/guide/run-and-monitor-work).
