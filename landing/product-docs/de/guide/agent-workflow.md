...
In **Messages** gibt es Einzelgespräche mit Teammitgliedern. Wenn Arbeit feststeckt, nutzen Sie die Fortsetzen-Aktion auf der Teamseite und prüfen Sie anschließend Aufgabe und Laufzeitprotokolle auf tatsächlichen Fortschritt.
